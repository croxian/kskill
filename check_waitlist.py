...
if free:
    ...
    print(f"\n빈자리는 없습니다. 예약대기로 표시된 열차가 {waitable}건 있지만,")
    print("매진 시간대에는 실제로 신청이 안 되는 경우가 많습니다.")
    print("앱에서 확인은 해보시되, 이것만 믿고 기다리지는 마세요.")
    print("취소표 감시를 같이 돌리는 편이 낫습니다.")
elif not can_judge_wait:
    print("\n빈자리가 없습니다. 취소표를 감시하거나 다른 시간대를 보세요.")
else:
    print("\n빈자리도 예약대기도 없습니다.")
