...
- **데이터센터 IP 에서도 동작이 확인됐습니다.** Oracle Cloud VM 에서 코레일
  로그인과 조회가 정상적으로 됐습니다(2026-09-22). 다만 확인된 사례는
  하나뿐이고, 코레일이 이후 정책을 바꿀 수도 있습니다. 안전하게 가려면
  **한국 리전**(서울/춘천)을 고르세요. 해외 리전은 굳이 쓸 이유가 없습니다.
