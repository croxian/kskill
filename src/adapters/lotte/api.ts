...
export const SEAT_STATUS = {
   ...
   * 남이 결제 화면에서 붙잡고 있는 중.
   *
   * 실측: 브라우저에서 B2 를 선택하고 결제 화면까지 가자, 밖에서 조회한
   * 그 좌석이 20초 만에 0 에서 20 으로 바뀌고 잔여수도 19 → 18 이 됐다.
   * 9관 360석 표본에서도 코드 20 은 단 1석뿐이었다 — 28(13석)·80(3석)·
   * 23(2석) 같은 구조적 좌석과 달리 그 순간에만 존재하는 상태다.
   */
  HELD: 20,
} as const;
